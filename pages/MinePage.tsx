...
const MinePage: React.FC = () => {
    const { user, isMining, miningEndTime, totalMiningRate, baseMiningRate, referralMiningRate, transactions, startMining, totalUsers, circulatingSupply, isAuthLoading } = useContext(UserContext);
