...
const WalletPage: React.FC = () => {
  const { user, riumBalance, trustBalance, unverifiedTrustBalance, swapTrustToRIUM, transactions, isWalletLocked, pinAttempts, totalEarnedTrust } = useContext(UserContext);
  const { showSuccessToast, showErrorToast } = useContext(AppContext); // Use AppContext toasts
